...
Please note that the demo uses `NGAvatarGroup` which is available since ithinkdt-ui `NEXT_VERSION`.
...
The `NGAvatarGroup` should be imported from 'ithinkdt-ui/generic'.
</markdown>
